...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Diesel Volume Cairo widget"
      End
      ...
      Begin VB.Menu mnuHelpSplash 
         Caption         =   "Diesel Volume One Page Help"
      End
      ...
      Begin VB.Menu mnuSwitchOff 
         Caption         =   "Switch off my functions (Volume Control)"
      End
...
Private Sub mnuAppFolder_Click()
   ...
   On Error GoTo mnuAppFolder_Click_Error
    ...
    Else
        MsgBox "Having a bit of a problem opening a folder for this widget - " & folderPath & " It doesn't seem to have a valid working directory set.", "Steampunk Volume Control Confirmation Message", vbOKOnly + vbExclamation
        'MessageBox Me.hWnd, "Having a bit of a problem opening a folder for that command - " & sCommand & " It doesn't seem to have a valid working directory set.", "Steampunk Volume Control Confirmation Message", vbOKOnly + vbExclamation
    End If
...
' Author    : beededea
' Date      : 05/05/2023
' Purpose   : menu item to lock the volumeForm in place
'---------------------------------------------------------------------------------------
'
...
' Author    : beededea
' Date      : 07/05/2023
' Purpose   : menu item to lock the volumeForm in place on the desktop
'---------------------------------------------------------------------------------------
'
...
Public Sub mnuLatest_Click()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hWnd, "Open", "https://github.com/yereverluvinunclebert/Steampunk-Volume-Control-" & gblCodingEnvironment & "/releases", vbNullString, App.Path, 1)
    End If
