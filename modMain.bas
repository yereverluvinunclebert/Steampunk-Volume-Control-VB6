...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    widgetName = "Steampunk Volume Control"
...
'        gblClockFaceSwitchPref = fGetINISetting(location, "clockFaceSwitchPref", gblSettingsFile)
        ...
        ' other
        gblClockHighDpiXPos = fGetINISetting("Software\SteampunkVolumeControl", "clockHighDpiXPos", gblSettingsFile)
        gblClockHighDpiYPos = fGetINISetting("Software\SteampunkVolumeControl", "clockHighDpiYPos", gblSettingsFile)
        
        gblClockLowDpiXPos = fGetINISetting("Software\SteampunkVolumeControl", "clockLowDpiXPos", gblSettingsFile)
        gblClockLowDpiYPos = fGetINISetting("Software\SteampunkVolumeControl", "clockLowDpiYPos", gblSettingsFile)
