      ...
      Begin VB.Frame fraConfigInner 
         ...
         Begin VB.Frame fraClockTooltips 
            ...
            Begin VB.OptionButton optGaugeTooltips 
               Caption         =   "Disable Control Tooltips *"
               Height          =   300
               Index           =   2
               Left            =   225
               TabIndex        =   160
            ...
            End
            Begin VB.OptionButton optGaugeTooltips 
               Caption         =   "Control - Enable Square Tooltips"
               Height          =   300
               Index           =   1
               Left            =   225
               TabIndex        =   159
            ...
            End
            Begin VB.OptionButton optGaugeTooltips 
               Caption         =   "Control - Enable Balloon Tooltips *"
               Height          =   315
               Index           =   0
               Left            =   225
               TabIndex        =   158
...
Private Sub chkAutoReconnect_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    If gblPrefsTooltips = "0" Then CreateToolTip chkAutoReconnect.hWnd, "Enable a regular three minute timer that will regularly reconnect to the windows audio subsystem", _
                  TTIconInfo, "Help on the Automatic Audio Reconnect Toggle", , , , True

End Sub

Private Sub chkNumericDisplay_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    If gblPrefsTooltips = "0" Then CreateToolTip chkNumericDisplay.hWnd, "When checked this box enables the numeric display that indicates the current audio volume.", _
                  TTIconInfo, "Help on the Numeric Value Toggle", , , , True
End Sub
...
Private Sub optGaugeTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "gaugeTooltips", gblGaugeTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            gblGaugePrimaryHeightRatio = fVolume.volumeForm.WidgetRoot.Zoom
            sPutINISetting "Software\SteampunkVolumeControl", "gaugePrimaryHeightRatio", gblGaugePrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\SteampunkVolumeControl", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblGaugeSecondaryHeightRatio = fVolume.volumeForm.WidgetRoot.Zoom
            sPutINISetting "Software\SteampunkVolumeControl", "gaugeSecondaryHeightRatio", gblGaugeSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\SteampunkVolumeControl", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Private Sub Form_Load()
    ...
    Me.mnuAbout.Caption = "About Steampunk Volume Control Cairo " & gblCodingEnvironment & " widget"
    ...
    ' note the monitor primary at the preferences form_load and store as gblOldvolumeFormMonitorPrimary
...
Public Sub positionPrefsMonitor()
    ...
    If formLeftTwips = 0 Then
        If ((fVolume.volumeForm.Left + fVolume.volumeForm.Width) * gblScreenTwipsPerPixelX) + 200 + widgetPrefs.Width > gblPhysicalScreenWidthTwips Then
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\SteampunkVolumeControl", "prefsPrimaryHeightTwips", gblSettingsFile)
            ...
            End If
        Else
            gblPrefsSecondaryHeightTwips = fGetINISetting("Software\SteampunkVolumeControl", "prefsSecondaryHeightTwips", gblSettingsFile)
            gblPrefsFormResizedInCode = True
...
Private Sub chkDpiAwareness_Click()
    ...
    If pvtPrefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "dpiAwareness", gblDpiAwareness, gblSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Steampunk-Volume-Control-VB6\Steampunk-Volume-Control-VB6.vbp"
...
Private Sub btnSave_Click()
    ...
    gblNumericDisplay = CStr(chkNumericDisplay.Value)
    gblAutoReconnect = CStr(chkAutoReconnect.Value)
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "SteampunkVolumeControl", """" & App.Path & "\" & "Steampunk-Volume-Control-VB6.exe""")
    Else
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "SteampunkVolumeControl", vbNullString)
    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "showTaskbar", gblShowTaskbar, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "showHelp", gblShowHelp, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "dpiAwareness", gblDpiAwareness, gblSettingsFile
        
        
        sPutINISetting "Software\SteampunkVolumeControl", "gaugeSize", gblGaugeSize, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "scrollWheelDirection", gblScrollWheelDirection, gblSettingsFile
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "widgetLandscape", gblWidgetLandscape, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "widgetPortrait", gblWidgetPortrait, gblSettingsFile

        sPutINISetting "Software\SteampunkVolumeControl", "prefsFont", gblPrefsFont, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "gaugeFont", gblGaugeFont, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "prefsFontSizeHighDPI", gblPrefsFontSizeHighDPI, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "prefsFontSizeLowDPI", gblPrefsFontSizeLowDPI, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "prefsFontItalics", gblPrefsFontItalics, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "prefsFontColour", gblPrefsFontColour, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\SteampunkVolumeControl", "windowLevel", gblWindowLevel, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "preventDragging", gblPreventDragging, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "opacity", gblOpacity, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "widgetHidden", gblWidgetHidden, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "hidingTime", gblHidingTime, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "ignoreMouse", gblIgnoreMouse, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
        
        
        sPutINISetting "Software\SteampunkVolumeControl", "startup", gblStartup, gblSettingsFile

        sPutINISetting "Software\SteampunkVolumeControl", "enableSounds", gblEnableSounds, gblSettingsFile
'        sPutINISetting "Software\SteampunkVolumeControl", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\SteampunkVolumeControl", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\SteampunkVolumeControl", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\SteampunkVolumeControl", "volumeBoost", gblVolumeBoost, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "lastSelectedTab", gblLastSelectedTab, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "debug", gblDebug, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "dblClickCommand", gblDblClickCommand, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "openFile", gblOpenFile, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "gaugeHighDpiXPos", gblGaugeHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "gaugeHighDpiYPos", gblGaugeHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "gaugeLowDpiXPos", gblGaugeLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "gaugeLowDpiYPos", gblGaugeLowDpiYPos, gblSettingsFile
...
Private Sub btnDisplayScreenFont_Click()
    ...
    If gblfVolumeAvailable = True Then
        fVolume.volumeForm.Widgets("lblTerminalText").Widget.FontSize = gblDisplayScreenFontSize
        fVolume.volumeForm.Widgets("lblTerminalText").Widget.FontName = gblDisplayScreenFont
    End If
...
'    chkVolumeBoost.Value = Val(gblVolumeBoost)
    ...
    lblGitHub.Caption = "You can find the code for the Steampunk Volume Control on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/Steampunk-Volume-Control"
...
'    With fVolume.volumeForm.Widgets("busy1").Widget
'        .Alpha = 1
'        .Refresh
'    End With
...
Private Sub chkWidgetFunctions_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    If gblPrefsTooltips = "0" Then CreateToolTip chkWidgetFunctions.hWnd, "When checked this box enables the gauge overall functionality. Any adjustment takes place instantly.", _
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hWnd, "Open", "https://github.com/yereverluvinunclebert/Steampunk-Volume-Control-" & gblCodingEnvironment, vbNullString, App.Path, 1)
    End If
...
Public Sub sliGaugeSize_Change()
    ...
    'If pvtAllowSizeChangeFlg = True Then Call fVolume.AdjustZoom(sliGaugeSize.Value / 100)
...
Public Property Let GaugeSize(ByVal newValue As Single)
   On Error GoTo gaugeSizeLet_Error
    ...
    Call fVolume.AdjustZoom(mGaugeSize)
   ...
   On Error GoTo setPrefsTooltips_Error
    ...
    ' next we just do the native VB6 tooltips
     If optPrefsTooltips(1).Value = True Then
        ...
        chkWidgetFunctions.ToolTipText = "When checked this box enables the gauge's functionality. Any adjustment takes place instantly. "
...
'    widgetPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\SteampunkVolumeControl", "skinTheme", gblSkinTheme, gblSettingsFile
