   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":2712
            Left            =   1530
            List            =   "frmPrefs.frx":2714
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
'    End If
    ...
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\SteampunkVolumeControl", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\SteampunkVolumeControl", "defaultEditor", gblDefaultEditor, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "clockHighDpiXPos", gblClockHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "clockHighDpiYPos", gblClockHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\SteampunkVolumeControl", "clockLowDpiXPos", gblClockLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\SteampunkVolumeControl", "clockLowDpiYPos", gblClockLowDpiYPos, gblSettingsFile
...
Private Sub adjustPrefsControls()
    ...
    txtDefaultEditor.Text = gblDefaultEditor
    lblGitHub.Caption = "You can find the code for the Steampunk Volume Control on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Steampunk-Volume-Control-VB6"
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Steampunk-Volume-Control-VB6", vbNullString, App.path, 1)
    End If
...
'        sliAnimationInterval.ToolTipText = "Adjust to make the animation smooth or choppy. Any adjustment in the interval takes place instantly. Lower values are smoother but the smoother it runs the more CPU it uses."
        ...
        btnFacebook.ToolTipText = "This will link you to the our Steampunk/Steampunkpunk program users Group."
